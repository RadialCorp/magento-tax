 ...
 * class. This test no longer tests Radial_Tax_Helper_Sdk, which no
...
class Radial_Tax_Test_Helper_SdkTest extends Radial_Core_Test_Base
{
    ...
    /** @var Radial_Tax_Model_Request_Builder_Quote */
    protected $_quoteRequestBuilder;
    /** @var Radial_Tax_Model_Response_Parser_Quote */
    ...
    protected $_taxCollectorException = 'Radial_Tax_Exception_Collector_Exception';
    ...
    public function setUp()
    {
        ...
        $this->_taxHelper = $this->getHelperMock('radial_tax/data', ['__']);
        ...
        $this->_quoteRequestBuilder = $this->getModelMockBuilder('radial_tax/request_builder_quote')
            ->disableOriginalConstructor()
            ->setMethods(['getTaxRequest'])
            ->getMock();

        $this->_quoteResponseParser = $this->getModelMockBuilder('radial_tax/response_parser_quote')
            ->disableOriginalConstructor()
        ...
        $this->_taxHelper = $this->getHelperMock('radial_tax', ['getConfigModel']);
    ...
    public function testExtractResponseResultsSuccess()
    {
        ...
        $sdkResult = $this->getModelMockBuilder('radial_tax/result')->disableOriginalConstructor()->getMock();
