...
class Radial_Tax_Test_Model_ObserverTest extends EcomDev_PHPUnit_Test_Case
{
    /** @var Radial_Eb2cCre_Model_Session */
    ...
    public function setUp()
    {
        ...
        $this->coreSession = $this->getModelMockBuilder('radial_core/session')
            ...
            ->getMock();
        $this->taxCollector = $this->getModelMock('radial_tax/collector', ['collectTaxes']);
    ...
    public function testHandleSalesQuoteCollectTotalsCollectFailure()
    {
        ...
        $this->taxCollector->expects($this->once())
            ->method('collectTaxes')
            ->will($this->throwException(Mage::exception('Radial_Tax_Exception_Collector')));
