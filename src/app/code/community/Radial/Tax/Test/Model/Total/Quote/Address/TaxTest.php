...
class Radial_Tax_Test_Model_Total_Quote_Address_TaxTest extends EcomDev_PHPUnit_Test_Case
{
    /** @var Mage_Sales_Model_Quote_Address */
    protected $_address;
    /** @var int */
    protected $_addressId = 4;
    /** @var Radial_Tax_Model_Quote_Address_Tax */
    protected $_taxTotal;
    ...
    public function setUp()
    {
        ...
        $this->_helper = $this->getHelperMock('radial_tax/data', ['__']);
        ...
        $this->_taxTotal = Mage::getModel(
            'radial_tax/total_quote_address_tax',
            [
    ...
    {
        $record = $this->getModelMockBuilder('radial_tax/duty')
            // Disable constructor to prevent the need to construct tax records with
            // a full tax payload, quote and quote address id.
            ->disableOriginalConstructor()
    ...
    {
        $record = $this->getModelMockBuilder('radial_tax/fee')
            // Disable constructor to prevent the need to construct tax records with
            // a full tax payload, quote and quote address id.
            ->disableOriginalConstructor()
            ->setMethods(['getAmount'])
    ...
    public function testFetch()
    {
        ...
        $expectedTotals = [
            ...
            'title' => Radial_Tax_Model_Total_Quote_Address_Tax::TAX_TOTAL_TITLE,
